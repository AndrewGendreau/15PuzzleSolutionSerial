...
*Author: Andrew Gendreau
**/
void mapTwoDArrayToOneD(int array[][BOARDHEIGHT], int oneDForm[BOARDSIZE])
{
	...
	currentOneDIndex = 0;
	for(currentX = 0; currentX < BOARDHEIGHT; currentX++)	//somewhere in here, the first row of array is lost
	{
